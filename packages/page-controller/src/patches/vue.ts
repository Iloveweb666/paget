 ...
 */
export function triggerVueInput(element: HTMLInputElement | HTMLTextAreaElement, value: string): void {
 ...
 */
export function triggerVueCheck(element: HTMLInputElement, checked: boolean): void {
 ...
 */
export function triggerVueSelect(element: HTMLSelectElement, value: string): void {
 ...
 */
export function isVueApp(): boolean {
  // 检查 Vue 3 devtools 钩子 / Check Vue 3 devtools hook
  if ('__vue_app__' in document.documentElement) return true
  ...
  if (root && '__vue_app__' in root) return true
  return false
}
